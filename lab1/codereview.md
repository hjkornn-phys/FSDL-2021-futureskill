...
있고 data split 역시 pytorch_lightning.trainer에 LightningDataModule 객체만 넣어주면 내부에서 정의된 train_dataloader등을 알아서 사용하므로, 코드가 매우 간편해집니다.

emnist.py에도 dataloader함수들이 존재하는데, 따로 호출하는 코드는 보이지 않습니다.
