...
def _import_class(module_and_class_name: str) -> type:
    ...
    class_ = getattr(module, class_name) # module.class_name
    return class_ # type == Callable
...
def _setup_parser():
    ...
    parser = argparse.ArgumentParser(add_help=False, parents=[trainer_parser]) # trainer argparse의 인자 모두 포함
    ...
    temp_args, _ = parser.parse_known_args() # 앞에서 정의된 인자 파싱
    ...
    data_class.add_to_argparse(data_group) # dataclass에 override된 staticmethod add_to_argparse 활용
...
def main():
    ...
    logger = pl.loggers.TensorBoardLogger("training/logs") #save dir 
